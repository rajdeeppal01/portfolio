...
<div class="terminal-rich-container">
    ...
    <div class="terminal-projects-grid">
        ...
        <div class="terminal-card project-terminal-card" data-project-id="trackrai">
            ...
            <h4 class="term-proj-title">TrackrAI — AI Job Application Tracker</h4>
            <p class="term-proj-desc" style="margin-bottom: 0.5rem;">
                A full-stack, AI-powered job application tracking dashboard. Manage applications across a smart Kanban pipeline, get AI-generated career insights, visualise analytics, and track every stage of the job hunt — all in a premium dark-mode UI.
            </p>
            <ul class="term-bullets" style="font-size: 0.82rem; margin-bottom: 0.85rem; color: var(--text-muted); list-style-type: none; padding-left: 0;">
                <li style="position: relative; padding-left: 0.85rem; margin-bottom: 0.35rem;"><strong style="color: var(--text-white);">Frontend:</strong> React 19 + Vite + Tailwind CSS v4, Framer Motion animations, animated theme toggle (dark/light), blue Skiper-style glow background.</li>
                <li style="position: relative; padding-left: 0.85rem; margin-bottom: 0.35rem;"><strong style="color: var(--text-white);">Backend:</strong> FastAPI + SQLite REST API deployed on Render; CRUD endpoints for applications with CORS-configured production access.</li>
                <li style="position: relative; padding-left: 0.85rem; margin-bottom: 0.35rem;"><strong style="color: var(--text-white);">AI Copilot:</strong> Gemini API integration that analyses application data and surfaces actionable career insights with a real-time chat interface.</li>
            </ul>
            <div class="term-tags">
                <span class="term-tag">React 19</span>
                <span class="term-tag">FastAPI</span>
                <span class="term-tag">Tailwind v4</span>
                <span class="term-tag">Gemini API</span>
                <span class="term-tag">Framer Motion</span>
                <span class="term-tag">Vercel + Render</span>
            </div>

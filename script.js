...
<div class="terminal-rich-container">
    ...
    <div class="terminal-projects-grid">
        ...
        <div class="terminal-card project-terminal-card" data-project-id="q-governance">
            ...
            <div class="term-proj-actions">
                <a href="https://q-vert-eight.vercel.app/" target="_blank" rel="noopener noreferrer" class="term-action-link">Live Demo ↗</a>
...
function getShowcaseHTML() {
    const showcaseItems = [
        ...
        },
        {
            ...
            status: 'LIVE',
            title: 'Q — Autonomous AI Agent Governance',
            desc: 'A security and governance middleware for autonomous AI agents. Intercepts high-risk tool calls and pushes them to a terminal-styled React dashboard for human approval via WebSockets.',
            tags: ['React', 'FastAPI', 'WebSockets', 'Cybersecurity'],
            url: 'https://q-vert-eight.vercel.app/',
            urlLabel: 'q-vert-eight.vercel.app'
        },
        {
            id: 'cybersentinel-ai',

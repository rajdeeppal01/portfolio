    ...
    <div class="terminal-projects-grid">
        ...
        <div class="terminal-card project-terminal-card" data-project-id="jcs-suite">
            ...
            <ul class="term-bullets" style="font-size: 0.82rem; margin-bottom: 0.85rem; color: var(--text-muted); list-style-type: none; padding-left: 0;">
                <li style="position: relative; padding-left: 0.85rem; margin-bottom: 0.35rem;"><strong style="color: var(--text-white);">Automated CVE Reconnaissance & Analysis:</strong> Engineered a target intelligence engine processing 50,000+ CVEs via SQLite/NVD parsing. Performs passive DNS mapping, TCP port sweeps, and deep static malware analysis (including YARA rules and hex dumping) to rank network vulnerabilities.</li>
